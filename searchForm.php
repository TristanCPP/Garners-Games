...
<div class="container">
    ...
    <div class="main-content">
        ...
        <html>
        <head>
            <title>TG's Games Store</title>
        </head>
        <body>
        <h1>Search for Games!</h1>
        <form action="search.php" method="post">
            <input type="text" name="search" placeholder="Search for Games">
            <button type="submit" name="action" value="Title">Search by Title</button>
            <button type="submit" name="action" value="Producer">Search by Producer</button>
            <br><br><br>
            <input type="text" name="lower" placeholder="Lower Price Limit">
            <br><br>
            <input type="text" name="upper" placeholder="Upper Price Limit">

            <button type="submit" name="action" value="Price">Search Price Range</button>
